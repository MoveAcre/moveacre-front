...
const beneficios = [
  {
    icon: "01",
    title: "Folga no trabalho",
    text: "A CLT garante ao trabalhador celetista um dia de ausência remunerada por ano para realizar a doação de sangue, mediante apresentação do comprovante emitido pelo Hemoacre. Válido para uma doação por ano.",
    tag: "CLT — Art. 473, IV",
  },
  {
    icon: "02",
    title: "Exames gratuitos",
    text: "Cada bolsa de sangue é testada obrigatoriamente para hepatite B e C, HIV, sífilis, doença de Chagas e HTLV. Você é notificado caso algum resultado precise de atenção médica — sem custo algum.",
    tag: "Obrigatório por lei",
  },
  {
    icon: "03",
    title: "Triagem clínica",
    text: "Antes de cada doação você passa por avaliação de pressão arterial, hemoglobina, peso e temperatura, realizada por profissional de saúde habilitado do Hemoacre. Totalmente gratuita.",
    tag: "Benefício direto",
  },
  {
    icon: "04",
    title: "Prioridade no SUS",
    text: "A Lei Federal nº 10.205/2001 garante ao doador cadastrado prioridade no atendimento em filas de transplantes de órgãos e tecidos no Sistema Único de Saúde.",
    tag: "Lei nº 10.205/2001",
  },
  {
    icon: "05",
    title: "Certificado oficial",
    text: "O Hemoacre emite comprovante oficial de doação a cada atendimento. Esse documento é necessário para acessar os benefícios trabalhistas e pode ser solicitado diretamente na unidade.",
    tag: "Hemoacre — AC",
  },
  {
    icon: "06",
    title: "Renovação sanguínea",
    text: "Após a doação, o organismo repõe o volume de plasma em cerca de 24 horas e as células vermelhas em até 60 dias. A medula óssea é estimulada a produzir novas células sanguíneas.",
    tag: "Fisiológico",
  },
];
